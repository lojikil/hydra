...
(define (typhon@init-env env)
    ...
    (dict-set! env "car" (dict type: 'primitive value: 0))
    (dict-set! env "call/cc" (dict type: 'primitive value: 106))
    (dict-set! env "cdr" (dict type: 'primitive value: 1))
    (dict-set! env "cons" (dict type: 'primitive value: 2))
    (dict-set! env "conjugate" (dict type: 'primitive value: 67))
    (dict-set! env "conjugate!" (dict type: 'primitive value: 68))
    (dict-set! env "complex?" (dict type: 'primitive value: 20))
    (dict-set! env "cos" (dict type: 'primitive value: 72))
    (dict-set! env "cosh" (dict type: 'primitive value: 79))
    (dict-set! env "coerce" (dict type: 'primitive value: 97))
    (dict-set! env "ceil" (dict type: 'primitive value: 35))
    (dict-set! env "ccons" (dict type: 'primitive value: 54))
    (dict-set! env "cset!" (dict type: 'primitive value: 58))
    (dict-set! env "cslice" (dict type: 'primitive value: 99))
    (dict-set! env "cupdate" (dict type: 'primitive value: 98))
    (dict-set! env "%load" (dict type: 'primitive value: 3))
    (dict-set! env "%list" (dict type: 'primitive value: 46))
    (dict-set! env "%nil" (dict type: 'primitive value: 4))
    (dict-set! env "%nop" (dict type: 'primitive value: 107))
    (dict-set! env "%-" (dict type: 'primitive value: 5))
    (dict-set! env "%+" (dict type: 'primitive value: 6))
    (dict-set! env "%*" (dict type: 'primitive value: 7))
    (dict-set! env "%/" (dict type: 'primitive value: 8))
    (dict-set! env "%<" (dict type: 'primitive value: 9))
    (dict-set! env "%<=" (dict type: 'primitive value: 11))
    (dict-set! env "%>" (dict type: 'primitive value: 10))
    (dict-set! env "%>=" (dict type: 'primitive value: 12))
    (dict-set! env "%=" (dict type: 'primitive value: 26))
    (dict-set! env "%jmp" (dict type: 'primitive value: 28))
    (dict-set! env "%cmp" (dict type: 'primitive value: 29))
    (dict-set! env "%call" (dict type: 'primitive value: 30))
    (dict-set! env "%env-load" (dict type: 'primitive value: 31))
    (dict-set! env "%tail-call" (dict type: 'primitive value: 32))
    (dict-set! env "%define" (dict type: 'primitive value: 33))
    (dict-set! env "%set!" (dict type: 'primitive value: 34))
    (dict-set! env "%string" (dict type: 'primitive value: 50))
    (dict-set! env "%vector" (dict type: 'primitive value: 47))
    (dict-set! env "%make-vector" (dict type: 'primitive value: 48))
    (dict-set! env "%make-string" (dict type: 'primitive value: 49))
    (dict-set! env "%ap" (dict type: 'primitive value: 108))
    (dict-set! env "%makeclosure" (dict type: 'primitive value: 109))
    (dict-set! env "%append" (dict type: 'primitive value: 51))
    (dict-set! env "if" (dict type: 'syntax value: 'primitive-syntax-if))
    (dict-set! env "inexact?" (dict type: 'primitive value: 15))
    (dict-set! env "inexact->exact" (dict type: 'primitive value: 39))
    (dict-set! env "integer?" (dict type: 'primitive value: 19))
    (dict-set! env "imag-part" (dict type: 'primitive value: 61))
    (dict-set! env "fn" (dict type: 'syntax value: 'primitive-syntax-fn))
    (dict-set! env "begin" (dict type: 'syntax value: 'primitive-syntax-begin))
    (dict-set! env "floor" (dict type: 'primitive value: 36))
    (dict-set! env "first" (dict type: 'primitive value: 52))
    (dict-set! env "lambda" (dict type: 'syntax value: 'primitive-syntax-fn))
    (dict-set! env "length" (dict type: 'primitive value: 13))
    (dict-set! env "lcm" (dict type: 'primitive value: 23))
    (dict-set! env "list" (dict type: 'syntax value: 'primitive-syntax-list))
    (dict-set! env "ln" (dict type: 'primitive value: 82))
    (dict-set! env "log2" (dict type: 'primitive value: 87))
    (dict-set! env "log10" (dict type: 'primitive value: 88))
    (dict-set! env "quote" (dict type: 'syntax value: 'primitive-syntax-quote))
    (dict-set! env "quotient" (dict type: 'primitive value: 40))
    (dict-set! env "quasi-quote" (dict type: 'syntax value: 'primitive-syntax-qquote))
    (dict-set! env "unquote" (dict type: 'syntax value: 'primitve-syntax-unquote))
    (dict-set! env "unquote-splice" (dict type: 'syntax value: 'primitive-syntax-unqsplice))
    (dict-set! env "exact?" (dict type: 'primitive value: 14))
    (dict-set! env "exp" (dict type: 'primitive value: 81))
    (dict-set! env "exp2" (dict type: 'primitive value: 85))
    (dict-set! env "expm1" (dict type: 'primitive value: 86))
    (dict-set! env "eq?" (dict type: 'primitive value: 27))
    (dict-set! env "empty?" (dict type: 'primitive value: 59))
    (dict-set! env "display" (dict type: 'procedure value: "display"))
    (dict-set! env "newline" (dict type: 'procedure value: "newline"))
    (dict-set! env "digamma-implementation" (dict type: 'procedure value: "digamma-implementation"))
    (dict-set! env "%dict" (dict type: 'primitive value: 94))
    (dict-set! env "dict" (dict type: 'syntax value: 'primitive-syntax-dict))
    (dict-set! env "dict-has?" (dict type: 'primitive value: 96))
    (dict-set! env "denomenator" (dict type: 'primitive value: 25))
    (dict-set! env "define" (dict type: 'syntax value: 'primitive-syntax-define))
    (dict-set! env "define-syntax" (dict type: 'syntax value: 'primitive-syntax-defsyn))
    (dict-set! env "define-macro" (dict type: 'syntax value: 'primitive-syntax-defmac))
    (dict-set! env "apply" (dict type: 'primitive value: 17))
    (dict-set! env "append" (dict type: 'syntax value: 'primitive-syntax-append))
    (dict-set! env "argument" (dict type: 'primitive value: 66))
    (dict-set! env "asin" (dict type: 'primitive value: 74))
    (dict-set! env "assq" (dict type: 'primitive value: 92))
    (dict-set! env "acos" (dict type: 'primitive value: 75))
    (dict-set! env "atan" (dict type: 'primitive value: 76))
    (dict-set! env "atan2" (dict type: 'primitive value: 77))
    (dict-set! env "abs" (dict type: 'primitive value: 83))
    (dict-set! env "real?" (dict type: 'primitive value: 18))
    (dict-set! env "real-part" (dict type: 'primitive value: 62))
    (dict-set! env "rest" (dict type: 'primitive value: 53))
    (dict-set! env "rectangular->polar" (dict type: 'primitive value: 70))
    (dict-set! env "rational?" (dict type: 'primitive value: 21))
    (dict-set! env "rationalize" (dict type: 'primitive value: 105))
    (dict-set! env "round" (dict type: 'primitive value: 38))
    (dict-set! env "gcd" (dict type: 'primitive value: 22))
    (dict-set! env "gensym" (dict type: 'primitive value: 60))
    (dict-set! env "numerator" (dict type: 'primitive value: 24))
    (dict-set! env "%nth" (dict type: 'primitive value: 55))
    (dict-set! env "nth" (dict type: 'syntax value: 'primitive-syntax-nth))
    (dict-set! env "+" (dict type: 'syntax value: 'primitive-syntax-plus))
    (dict-set! env "-" (dict type: 'syntax value: 'primitive-syntax-minus))
    (dict-set! env "*" (dict type: 'syntax value: 'primitive-syntax-mult))
    (dict-set! env "/" (dict type: 'syntax value: 'primitive-syntax-div))
    (dict-set! env "<" (dict type: 'syntax value: 'primitive-syntax-lt))
    (dict-set! env "<=" (dict type: 'syntax value: 'primitive-syntax-lte))
    (dict-set! env "<<" (dict type: 'primitive value: 89))
    (dict-set! env ">" (dict type: 'syntax value: 'primitive-syntax-gt))
    (dict-set! env ">=" (dict type: 'syntax value: 'primitive-syntax-gte))
    (dict-set! env ">>" (dict type: 'primitive value: 90))
    (dict-set! env "=" (dict type: 'syntax value: 'primitive-syntax-numeq))
    (dict-set! env "set!" (dict type: 'syntax value: 'primitive-syntax-set))
    (dict-set! env "string" (dict type: 'syntax value: 'primitive-syntax-string))
    (dict-set! env "%string-append" (dict type: 'primitive value: 91))
    (dict-set! env "sin" (dict type: 'primitive value: 71))
    (dict-set! env "sinh" (dict type: 'primitive value: 78))
    (dict-set! env "sqrt" (dict type: 'primitive value: 84))
    (dict-set! env "truncate" (dict type: 'primitive value: 37))
    (dict-set! env "tan" (dict type: 'primitive value: 73))
    (dict-set! env "tanh" (dict type: 'primitive value: 80))
    (dict-set! env "tconc!" (dict type: 'primitive value: 100))
    (dict-set! env "tconc-list" (dict type: 'primitive value: 102))
    (dict-set! env "tconc->pair" (dict type: 'primitive value: 103))
    (dict-set! env "tconc-splice" (dict type: 'primitive value: 104))
    (dict-set! env "modulo" (dict type: 'primitive value: 41))
    (dict-set! env "make-vector" (dict type: 'syntax value: 'primitive-syntax-makevector))
    (dict-set! env "make-string" (dict type: 'syntax value: 'primitive-syntax-makestring))
    (dict-set! env "make-rectangular" (dict type: 'primitive value: 63))
    (dict-set! env "make-polar" (dict type: 'primitive value: 64))
    (dict-set! env "make-dict" (dict type: 'primitive value: 95))
    (dict-set! env "make-tconc" (dict type: 'primitive value: 101))
    (dict-set! env "magnitude" (dict type: 'primitive value: 65))
    (dict-set! env "memq" (dict type: 'primitive value: 93))
    (dict-set! env "&" (dict type: 'primitive value: 42))
    (dict-set! env "|" (dict type: 'primitive value: 43))
    (dict-set! env "^" (dict type: 'primitive value: 44))
    (dict-set! env "~" (dict type: 'primitive value: 45))
    (dict-set! env "vector" (dict type: 'syntax value: 'primitive-syntax-vector))
    (dict-set! env "keys" (dict type: 'primitive value: 56))
    (dict-set! env "partial-key?" (dict type: 'primitive value: 57))
    (dict-set! env "polar->rectangular" (dict type: 'primitive value: 69))
    (dict-set! env "type" (dict type: 'primitive value: 111))
    (dict-set! env "load" (dict type: 'procedure value: "load"))
    (dict-set! env "read" (dict type: 'procedure value: "read"))
    (dict-set! env "write" (dict type: 'procedure value: "write"))
    (dict-set! env "format" (dict type: 'procedure value: "format"))
    (dict-set! env "macro-expand" (dict type: 'procedure value: "macro-expand"))
    (dict-set! env "syntax-expand" (dict type: 'procedure value: "syntax-expand"))
    ;(dict-set! env "interrogate" (dict type: 'procedure value: "interrogate"))
    (dict-set! env "system" (dict type: 'procedure value: "system"))
    (dict-set! env "pwd" (dict type: 'procedure value: "pwd"))
    (dict-set! env "cd" (dict type: 'procedure value: "cd"))
    (dict-set! env "chdir" (dict type: 'procedure value: "chdir"))
    (dict-set! env "ls" (dict type: 'procedure value: "ls"))
    (dict-set! env "open" (dict type: 'procedure value: "open"))
    (dict-set! env "close" (dict type: 'procedure value: "close"))
    (dict-set! env "read-char" (dict type: 'procedure value: "read-char"))
    (dict-set! env "read-string" (dict type: 'procedure value: "read-string"))
    (dict-set! env "write-char" (dict type: 'procedure value: "write-char"))
    (dict-set! env "dial" (dict type: 'procedure value: "dial"))
    (dict-set! env "announce" (dict type: 'procedure value: "announce"))
    (dict-set! env "listen" (dict type: 'procedure value: "listen"))
    (dict-set! env "accept" (dict type: 'procedure value: "accept"))
    (dict-set! env "hangup" (dict type: 'procedure value: "hangup"))
    (dict-set! env "remote-port-open?" (dict type: 'procedure value: "remote-port-open?"))
    (dict-set! env "gethostbyname" (dict type: 'procedure value: "gethostbyname"))
    (dict-set! env "gethostbyaddr" (dict type: 'procedure value: "gethostbyaddr"))
    (dict-set! env "peek-char" (dict type: 'procedure value: "peek-char"))
    (dict-set! env "port-filename" (dict type: 'procedure value: "port-filename"))
    (dict-set! env "port-mode" (dict type: 'procedure value: "port-mode"))
    (dict-set! env "port-remote-port" (dict type: 'procedure value: "port-remote-port"))
    (dict-set! env "port-protocol" (dict type: 'procedure value: "port-protocol"))
    (dict-set! env "port-state" (dict type: 'procedure value: "port-state"))
    (dict-set! env "port-type" (dict type: 'procedure value: "port-type"))
    (dict-set! env "end-of-port?" (dict type: 'procedure value: "end-of-port?"))
    (dict-set! env "random" (dict type: 'procedure value: "random"))
    (dict-set! env "seed-random" (dict type: 'procedure value: "seed-random"))
    (dict-set! env "sys/gettimeofday" (dict type: 'procedure value: "sys/gettimeofday"))
    (dict-set! env "sys/getuid" (dict type: 'procedure value: "sys/getuid"))
    (dict-set! env "sys/geteuid" (dict type: 'procedure value: "sys/geteuid"))
    (dict-set! env "sys/getgid" (dict type: 'procedure value: "sys/getgid"))
    (dict-set! env "sys/getegid" (dict type: 'procedure value: "sys/getegid"))
    (dict-set! env "sys/set*id" (dict type: 'procedure value: "sys/set*id"))
    (dict-set! env "sys/open" (dict type: 'procedure value: "sys/open"))
    (dict-set! env "sys/close" (dict type: 'procedure value: "sys/close"))
    (dict-set! env "sys/read" (dict type: 'procedure value: "sys/read"))
    (dict-set! env "sys/write" (dict type: 'procedure value: "sys/write"))
    (dict-set! env "sys/pipe" (dict type: 'procedure value: "sys/pipe"))
    (dict-set! env "sys/fork" (dict type: 'procedure value: "sys/fork"))
    (dict-set! env "sys/wait" (dict type: 'procedure value: "sys/wait"))
    (dict-set! env "sys/exec" (dict type: 'procedure value: "sys/exec"))
    (dict-set! env "sys/popen" (dict type: 'procedure value: "sys/popen"))
    (dict-set! env "sys/pclose" (dict type: 'procedure value: "sys/pclose"))
    (dict-set! env "sys/vfork" (dict type: 'procedure value: "sys/vfork"))
    (dict-set! env "sys/kill" (dict type: 'procedure value: "sys/kill"))
    (dict-set! env "sys/stat" (dict type: 'procedure value: "sys/stat"))
    (dict-set! env "sys/*sockopt" (dict type: 'procedure value: "sys/*sockopt"))
    (dict-set! env "sys/time" (dict type: 'procedure value: "sys/time"))
    (dict-set! env "sys/chown" (dict type: 'procedure value: "sys/chown"))
    (dict-set! env "sys/chmod" (dict type: 'procedure value: "sys/chmod"))
    (dict-set! env "sys/chroot" (dict type: 'procedure value: "sys/chroot"))
    (dict-set! env "sys/getenv" (dict type: 'procedure value: "sys/getenv"))
    (dict-set! env "sys/setenv" (dict type: 'procedure value: "sys/setenv"))
    (dict-set! env "sys/fcntl" (dict type: 'procedure value: "sys/fcntl"))
    (dict-set! env "sys/fcntl-const" (dict type: 'procedure value: "sys/fcntl-const"))
    (dict-set! env "sys/sleep" (dict type: 'procedure value: "sys/sleep"))
    (dict-set! env "sys/usleep" (dict type: 'procedure value: "sys/usleep"))
    (dict-set! env "sys/nanosleep" (dict type: 'procedure value: "sys/nanosleep"))
    (dict-set! env "sys/select" (dict type: 'procedure value: "sys/select"))
    (dict-set! env "sys/getpid" (dict type: 'procedure value: "sys/getpid"))
    (dict-set! env "sys/getppid" (dict type: 'procedure value: "sys/getppid"))
    (dict-set! env "write-buffer" (dict type: 'procedure value: "write-buffer"))
    (dict-set! env "read-buffer" (dict type: 'procedure value: "read-buffer"))
    (dict-set! env "read-string" (dict type: 'procedure value: "read-string")))
...
(define (typhon@compile-help sym iter-list params env)
    ...
    (if (null? iter-list)
        ...
        (append
            ...
            (list (list (primitive-value (typhon@lookup sym env))))
                                ...
                                (cond
                                            ...
                                            (cond
                                                (pair? name) 
                                                    (append
                                                        ...
                                                        (list (list (primitive-value (typhon@lookup '%define env))))) 
                                                (symbol? name)
                                                    (append
                                        ...
                                        (let ((name (car rst))
                                           ...
                                           (if (symbol? name) 
                                                (append
                                                    (typhon@compile value params env)
                                                    (list (list 3 name))
                                                    (list (list (primitive-value (typhon@lookup '%set! env)))))
                                    ...
                                    (eq? (primitive-value v) 'primitive-syntax-fn)
                                        (list
                                            ...
                                            (list (primitive-value (typhon@lookup '%makeclosure env))))
                                    ...
                                    (eq? (primitive-value v) 'primitive-syntax-list)
                                        ...
                                        (if (null? rst)
                                            ...
                                            (append
                                                ...
                                                (list (list (primitive-value (typhon@lookup '%list env))))))
                                        ...
                                        (if (null? rst)
                                            ...
                                            (append
                                                (reverse-append
                                                    (typhon@map rst params env))
                                                (list (list 3 (length rst)))
                                                (list (list (primitive-value (typhon@lookup '%vector env))))))
                                        ...
                                        (if (null? rst)
                                            ...
                                            (append
                                                (reverse-append
                                                    (typhon@map rst params env))
                                                (list (list 3 (length rst)))
                                                (list (list (primitive-value (typhon@lookup '%dict env))))))
                                        ...
                                        (if (null? rst)
                                            ...
                                            (append
                                                (reverse-append
                                                    (typhon@map rst params env))
                                                (list (list 3 (length rst)))
                                                (list (list (primitive-value (typhon@lookup '%string env))))))
                                        ...
                                        (if (null? rst)
                                            ...
                                            (append
                                                (reverse-append
                                                    (typhon@map rst params env))
                                                (list (list 3 (length rst)))
                                                (list (list (primitive-value (typhon@lookup '%append env))))))
                                            ...
                                            (cond
                                                (= l 1)
                                                    (append
                                                        '((4))
                                                        (typhon@compile (car rst) params env)
                                                        (list (list (primitive-value (typhon@lookup '%make-vector env)))))
                                                (= l 2)
                                                    (append
                                            ...
                                            (cond
                                                (= l 1)
                                                    (append
                                                        '((3 #\space))
                                                        (typhon@compile (car rst) params env)
                                                        (list (list (primitive-value (typhon@lookup '%make-string env)))))
                                                (= l 2)
                                                    (append
                                                        (reverse-append (typhon@map rst params env))
                                                        (list (list (primitive-value (typhon@lookup '%make-string env)))))
