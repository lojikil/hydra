...
(define (typhon@init-env env)
    ...
    (dict-set! env "car" (make-typhon-primitive 0))
    (dict-set! env "call/cc" (make-typhon-primitive 106))
    (dict-set! env "cdr" (make-typhon-primitive 1))
    (dict-set! env "cons" (make-typhon-primitive 2))
    (dict-set! env "conjugate" (make-typhon-primitive 67))
    (dict-set! env "conjugate!" (make-typhon-primitive 68))
    (dict-set! env "complex?" (make-typhon-primitive 20))
    (dict-set! env "cos" (make-typhon-primitive 72))
    (dict-set! env "cosh" (make-typhon-primitive 79))
    (dict-set! env "coerce" (make-typhon-primitive 97))
    (dict-set! env "ceil" (make-typhon-primitive 35))
    (dict-set! env "ccons" (make-typhon-primitive 54))
    (dict-set! env "cset!" (make-typhon-primitive 58))
    (dict-set! env "cslice" (make-typhon-primitive 99))
    (dict-set! env "cupdate" (make-typhon-primitive 98))
    (dict-set! env "%load" (make-typhon-primitive 3))
    (dict-set! env "%list" (make-typhon-primitive 46))
    (dict-set! env "%nil" (make-typhon-primitive 4))
    (dict-set! env "%nop" (make-typhon-primitive 107))
    (dict-set! env "%-" (make-typhon-primitive 5))
    (dict-set! env "%+" (make-typhon-primitive 6))
    (dict-set! env "%*" (make-typhon-primitive 7))
    (dict-set! env "%/" (make-typhon-primitive 8))
    (dict-set! env "%<" (make-typhon-primitive 9))
    (dict-set! env "%<=" (make-typhon-primitive 11))
    (dict-set! env "%>" (make-typhon-primitive 10))
    (dict-set! env "%>=" (make-typhon-primitive 12))
    (dict-set! env "%=" (make-typhon-primitive 26))
    (dict-set! env "%jmp" (make-typhon-primitive 28))
    (dict-set! env "%cmp" (make-typhon-primitive 29))
    (dict-set! env "%call" (make-typhon-primitive 30))
    (dict-set! env "%env-load" (make-typhon-primitive 31))
    (dict-set! env "%tail-call" (make-typhon-primitive 32))
    (dict-set! env "%define" (make-typhon-primitive 33))
    (dict-set! env "%set!" (make-typhon-primitive 34))
    (dict-set! env "%string" (make-typhon-primitive 50))
    (dict-set! env "%vector" (make-typhon-primitive 47))
    (dict-set! env "%make-vector" (make-typhon-primitive 48))
    (dict-set! env "%make-string" (make-typhon-primitive 49))
    (dict-set! env "%ap" (make-typhon-primitive 108))
    (dict-set! env "%makeclosure" (make-typhon-primitive 109))
    (dict-set! env "%append" (make-typhon-primitive 51))
    (dict-set! env "if" (make-typhon-syntax 'primitive-syntax-if))
    (dict-set! env "inexact?" (make-typhon-primitive 15))
    (dict-set! env "inexact->exact" (make-typhon-primitive 39))
    (dict-set! env "integer?" (make-typhon-primitive 19))
    (dict-set! env "imag-part" (make-typhon-primitive 61))
    (dict-set! env "floor" (make-typhon-primitive 36))
    (dict-set! env "first" (make-typhon-primitive 52))
    (dict-set! env "length" (make-typhon-primitive 13))
    (dict-set! env "lcm" (make-typhon-primitive 23))
    (dict-set! env "ln" (make-typhon-primitive 82))
    (dict-set! env "log2" (make-typhon-primitive 87))
    (dict-set! env "log10" (make-typhon-primitive 88))
    (dict-set! env "exact?" (make-typhon-primitive 14))
    (dict-set! env "exp" (make-typhon-primitive 81))
    (dict-set! env "exp2" (make-typhon-primitive 85))
    (dict-set! env "expm1" (make-typhon-primitive 86))
    (dict-set! env "eq?" (make-typhon-primitive 27))
    (dict-set! env "empty?" (make-typhon-primitive 59))
    (dict-set! env "quotient" (make-typhon-primitive 40))
    (dict-set! env "%dict" (make-typhon-primitive 94))
    (dict-set! env "dict-has?" (make-typhon-primitive 96))
    (dict-set! env "denomenator" (make-typhon-primitive 25))
    (dict-set! env "apply" (make-typhon-primitive 17))
    (dict-set! env "argument" (make-typhon-primitive 66))
    (dict-set! env "asin" (make-typhon-primitive 74))
    (dict-set! env "assq" (make-typhon-primitive 92))
    (dict-set! env "acos" (make-typhon-primitive 75))
    (dict-set! env "atan" (make-typhon-primitive 76))
    (dict-set! env "atan2" (make-typhon-primitive 77))
    (dict-set! env "abs" (make-typhon-primitive 83))
    (dict-set! env "real?" (make-typhon-primitive 18))
    (dict-set! env "real-part" (make-typhon-primitive 62))
    (dict-set! env "rest" (make-typhon-primitive 53))
    (dict-set! env "rectangular->polar" (make-typhon-primitive 70))
    (dict-set! env "rational?" (make-typhon-primitive 21))
    (dict-set! env "rationalize" (make-typhon-primitive 105))
    (dict-set! env "round" (make-typhon-primitive 38))
    (dict-set! env "gcd" (make-typhon-primitive 22))
    (dict-set! env "gensym" (make-typhon-primitive 60))
    (dict-set! env "numerator" (make-typhon-primitive 24))
    (dict-set! env "%nth" (make-typhon-primitive 55))
    (dict-set! env "<<" (make-typhon-primitive 89))
    (dict-set! env ">>" (make-typhon-primitive 90))
    (dict-set! env "%string-append" (make-typhon-primitive 91))
    (dict-set! env "sin" (make-typhon-primitive 71))
    (dict-set! env "sinh" (make-typhon-primitive 78))
    (dict-set! env "sqrt" (make-typhon-primitive 84))
    (dict-set! env "truncate" (make-typhon-primitive 37))
    (dict-set! env "tan" (make-typhon-primitive 73))
    (dict-set! env "tanh" (make-typhon-primitive 80))
    (dict-set! env "tconc!" (make-typhon-primitive 100))
    (dict-set! env "tconc-list" (make-typhon-primitive 102))
    (dict-set! env "tconc->pair" (make-typhon-primitive 103))
    (dict-set! env "tconc-splice" (make-typhon-primitive 104))
    (dict-set! env "modulo" (make-typhon-primitive 41))
    (dict-set! env "keys" (make-typhon-primitive 56))
    (dict-set! env "partial-key?" (make-typhon-primitive 57))
    (dict-set! env "polar->rectangular" (make-typhon-primitive 69))
    (dict-set! env "type" (make-typhon-primitive 111))
    (dict-set! env "make-rectangular" (make-typhon-primitive 63))
    (dict-set! env "make-polar" (make-typhon-primitive 64))
    (dict-set! env "make-dict" (make-typhon-primitive 95))
    (dict-set! env "make-tconc" (make-typhon-primitive 101))
    (dict-set! env "magnitude" (make-typhon-primitive 65))
    (dict-set! env "memq" (make-typhon-primitive 93))
    (dict-set! env "&" (make-typhon-primitive 42))
    (dict-set! env "|" (make-typhon-primitive 43))
    (dict-set! env "^" (make-typhon-primitive 44))
    (dict-set! env "~" (make-typhon-primitive 45))
    ...
    (dict-set! env "list" (make-typhon-syntax 'primitive-syntax-list))
    ...
    (dict-set! env "dict" (make-typhon-syntax 'primitive-syntax-dict))
    ...
    (dict-set! env "append" (make-typhon-syntax 'primitive-syntax-append))
    (dict-set! env "nth" (make-typhon-syntax 'primitive-syntax-nth))
    (dict-set! env "+" (make-typhon-syntax 'primitive-syntax-plus))
    (dict-set! env "-" (make-typhon-syntax 'primitive-syntax-minus))
    (dict-set! env "*" (make-typhon-syntax 'primitive-syntax-mult))
    (dict-set! env "/" (make-typhon-syntax 'primitive-syntax-div))
    (dict-set! env "<" (make-typhon-syntax 'primitive-syntax-lt))
    (dict-set! env "<=" (make-typhon-syntax 'primitive-syntax-lte))
    (dict-set! env ">" (make-typhon-syntax 'primitive-syntax-gt))
    (dict-set! env ">=" (make-typhon-syntax 'primitive-syntax-gte))
    ...
    (dict-set! env "display" (make-typhon-procedure "display"))
    (dict-set! env "newline" (make-typhon-procedure "newline"))
    (dict-set! env "digamma-implementation" (make-typhon-procedure "digamma-implementation"))
    (dict-set! env "load" (make-typhon-procedure "load"))
    (dict-set! env "read" (make-typhon-procedure "read"))
    (dict-set! env "write" (make-typhon-procedure "write"))
    (dict-set! env "format" (make-typhon-procedure "format"))
    (dict-set! env "macro-expand" (make-typhon-procedure "macro-expand"))
    (dict-set! env "syntax-expand" (make-typhon-procedure "syntax-expand"))
    ;(dict-set! env "interrogate" (make-typhon-procedure "interrogate"))
    (dict-set! env "eval" (make-typhon-procedure "eval"))
    (dict-set! env "default-environment" (make-typhon-procedure "default-environment"))
    (dict-set! env "null-environment" (make-typhon-procedure "null-environment"))
    (dict-set! env "make-environment" (make-typhon-procedure "make-environment"))
    (dict-set! env "clone-environment" (make-typhon-procedure "clone-environment"))
    (dict-set! env "set-environment!" (make-typhon-procedure "environment-set!"))
    (dict-set! env "bind-environment" (make-typhon-procedure "bind-environment"))
    (dict-set! env "current-environment" (make-typhon-procedure "default-environment"))
    (dict-set! env "system" (make-typhon-procedure "system"))
    (dict-set! env "pwd" (make-typhon-procedure "pwd"))
    (dict-set! env "cd" (make-typhon-procedure "cd"))
    (dict-set! env "chdir" (make-typhon-procedure "chdir"))
    (dict-set! env "ls" (make-typhon-procedure "ls"))
    (dict-set! env "open" (make-typhon-procedure "open"))
    (dict-set! env "close" (make-typhon-procedure "close"))
    (dict-set! env "read-char" (make-typhon-procedure "read-char"))
    (dict-set! env "read-string" (make-typhon-procedure "read-string"))
    (dict-set! env "write-char" (make-typhon-procedure "write-char"))
    (dict-set! env "dial" (make-typhon-procedure "dial"))
    (dict-set! env "announce" (make-typhon-procedure "announce"))
    (dict-set! env "listen" (make-typhon-procedure "listen"))
    (dict-set! env "accept" (make-typhon-procedure "accept"))
    (dict-set! env "hangup" (make-typhon-procedure "hangup"))
    (dict-set! env "remote-port-open?" (make-typhon-procedure "remote-port-open?"))
    (dict-set! env "gethostbyname" (make-typhon-procedure "gethostbyname"))
    (dict-set! env "gethostbyaddr" (make-typhon-procedure "gethostbyaddr"))
    (dict-set! env "peek-char" (make-typhon-procedure "peek-char"))
    (dict-set! env "port-filename" (make-typhon-procedure "port-filename"))
    (dict-set! env "port-mode" (make-typhon-procedure "port-mode"))
    (dict-set! env "port-remote-port" (make-typhon-procedure "port-remote-port"))
    (dict-set! env "port-protocol" (make-typhon-procedure "port-protocol"))
    (dict-set! env "port-state" (make-typhon-procedure "port-state"))
    (dict-set! env "port-type" (make-typhon-procedure "port-type"))
    (dict-set! env "end-of-port?" (make-typhon-procedure "end-of-port?"))
    (dict-set! env "random" (make-typhon-procedure "random"))
    (dict-set! env "seed-random" (make-typhon-procedure "seed-random"))
    (dict-set! env "sys/gettimeofday" (make-typhon-procedure "sys/gettimeofday"))
    (dict-set! env "sys/getuid" (make-typhon-procedure "sys/getuid"))
    (dict-set! env "sys/geteuid" (make-typhon-procedure "sys/geteuid"))
    (dict-set! env "sys/getgid" (make-typhon-procedure "sys/getgid"))
    (dict-set! env "sys/getegid" (make-typhon-procedure "sys/getegid"))
    (dict-set! env "sys/set*id" (make-typhon-procedure "sys/set*id"))
    (dict-set! env "sys/open" (make-typhon-procedure "sys/open"))
    (dict-set! env "sys/close" (make-typhon-procedure "sys/close"))
    (dict-set! env "sys/read" (make-typhon-procedure "sys/read"))
    (dict-set! env "sys/write" (make-typhon-procedure "sys/write"))
    (dict-set! env "sys/pipe" (make-typhon-procedure "sys/pipe"))
    (dict-set! env "sys/fork" (make-typhon-procedure "sys/fork"))
    (dict-set! env "sys/wait" (make-typhon-procedure "sys/wait"))
    (dict-set! env "sys/exec" (make-typhon-procedure "sys/exec"))
    (dict-set! env "sys/popen" (make-typhon-procedure "sys/popen"))
    (dict-set! env "sys/pclose" (make-typhon-procedure "sys/pclose"))
    (dict-set! env "sys/vfork" (make-typhon-procedure "sys/vfork"))
    (dict-set! env "sys/kill" (make-typhon-procedure "sys/kill"))
    (dict-set! env "sys/stat" (make-typhon-procedure "sys/stat"))
    (dict-set! env "sys/*sockopt" (make-typhon-procedure "sys/*sockopt"))
    (dict-set! env "sys/time" (make-typhon-procedure "sys/time"))
    (dict-set! env "sys/chown" (make-typhon-procedure "sys/chown"))
    (dict-set! env "sys/chmod" (make-typhon-procedure "sys/chmod"))
    (dict-set! env "sys/chroot" (make-typhon-procedure "sys/chroot"))
    (dict-set! env "sys/getenv" (make-typhon-procedure "sys/getenv"))
    (dict-set! env "sys/setenv" (make-typhon-procedure "sys/setenv"))
    (dict-set! env "sys/fcntl" (make-typhon-procedure "sys/fcntl"))
    (dict-set! env "sys/fcntl-const" (make-typhon-procedure "sys/fcntl-const"))
    (dict-set! env "sys/sleep" (make-typhon-procedure "sys/sleep"))
    (dict-set! env "sys/usleep" (make-typhon-procedure "sys/usleep"))
    (dict-set! env "sys/nanosleep" (make-typhon-procedure "sys/nanosleep"))
    (dict-set! env "sys/select" (make-typhon-procedure "sys/select"))
    (dict-set! env "sys/getpid" (make-typhon-procedure "sys/getpid"))
    (dict-set! env "sys/getppid" (make-typhon-procedure "sys/getppid"))
    (dict-set! env "write-buffer" (make-typhon-procedure "write-buffer"))
    (dict-set! env "read-buffer" (make-typhon-procedure "read-buffer"))
    (dict-set! env "read-string" (make-typhon-procedure "read-string")))
