...
(define (typhon@init-env env)
    ...
    (dict-set! env "car" (make-primitive 0))
    (dict-set! env "call/cc" (make-primitive 106))
    (dict-set! env "cdr" (make-primitive 1))
    (dict-set! env "cons" (make-primitive 2))
    (dict-set! env "conjugate" (make-primitive 67))
    (dict-set! env "conjugate!" (make-primitive 68))
    (dict-set! env "complex?" (make-primitive 20))
    (dict-set! env "cos" (make-primitive 72))
    (dict-set! env "cosh" (make-primitive 79))
    (dict-set! env "coerce" (make-primitive 97))
    (dict-set! env "ceil" (make-primitive 35))
    (dict-set! env "ccons" (make-primitive 54))
    (dict-set! env "cset!" (make-primitive 58))
    (dict-set! env "cslice" (make-primitive 99))
    (dict-set! env "cupdate" (make-primitive 98))
    (dict-set! env "%load" (make-primitive 3))
    (dict-set! env "%list" (make-primitive 46))
    (dict-set! env "%nil" (make-primitive 4))
    (dict-set! env "%nop" (make-primitive 107))
    (dict-set! env "%-" (make-primitive 5))
    (dict-set! env "%+" (make-primitive 6))
    (dict-set! env "%*" (make-primitive 7))
    (dict-set! env "%/" (make-primitive 8))
    (dict-set! env "%<" (make-primitive 9))
    (dict-set! env "%<=" (make-primitive 11))
    (dict-set! env "%>" (make-primitive 10))
    (dict-set! env "%>=" (make-primitive 12))
    (dict-set! env "%=" (make-primitive 26))
    (dict-set! env "%jmp" (make-primitive 28))
    (dict-set! env "%cmp" (make-primitive 29))
    (dict-set! env "%call" (make-primitive 30))
    (dict-set! env "%env-load" (make-primitive 31))
    (dict-set! env "%tail-call" (make-primitive 32))
    (dict-set! env "%define" (make-primitive 33))
    (dict-set! env "%set!" (make-primitive 34))
    (dict-set! env "%string" (make-primitive 50))
    (dict-set! env "%vector" (make-primitive 47))
    (dict-set! env "%make-vector" (make-primitive 48))
    (dict-set! env "%make-string" (make-primitive 49))
    (dict-set! env "%ap" (make-primitive 108))
    (dict-set! env "%makeclosure" (make-primitive 109))
    (dict-set! env "%append" (make-primitive 51))
    (dict-set! env "if" (make-syntax 'primitive-syntax-if))
    (dict-set! env "inexact?" (make-primitive 15))
    (dict-set! env "inexact->exact" (make-primitive 39))
    (dict-set! env "integer?" (make-primitive 19))
    (dict-set! env "imag-part" (make-primitive 61))
    (dict-set! env "floor" (make-primitive 36))
    (dict-set! env "first" (make-primitive 52))
    (dict-set! env "length" (make-primitive 13))
    (dict-set! env "lcm" (make-primitive 23))
    (dict-set! env "ln" (make-primitive 82))
    (dict-set! env "log2" (make-primitive 87))
    (dict-set! env "log10" (make-primitive 88))
    (dict-set! env "exact?" (make-primitive 14))
    (dict-set! env "exp" (make-primitive 81))
    (dict-set! env "exp2" (make-primitive 85))
    (dict-set! env "expm1" (make-primitive 86))
    (dict-set! env "eq?" (make-primitive 27))
    (dict-set! env "empty?" (make-primitive 59))
    (dict-set! env "quotient" (make-primitive 40))
    (dict-set! env "%dict" (make-primitive 94))
    (dict-set! env "dict-has?" (make-primitive 96))
    (dict-set! env "denomenator" (make-primitive 25))
    (dict-set! env "apply" (make-primitive 17))
    (dict-set! env "argument" (make-primitive 66))
    (dict-set! env "asin" (make-primitive 74))
    (dict-set! env "assq" (make-primitive 92))
    (dict-set! env "acos" (make-primitive 75))
    (dict-set! env "atan" (make-primitive 76))
    (dict-set! env "atan2" (make-primitive 77))
    (dict-set! env "abs" (make-primitive 83))
    (dict-set! env "real?" (make-primitive 18))
    (dict-set! env "real-part" (make-primitive 62))
    (dict-set! env "rest" (make-primitive 53))
    (dict-set! env "rectangular->polar" (make-primitive 70))
    (dict-set! env "rational?" (make-primitive 21))
    (dict-set! env "rationalize" (make-primitive 105))
    (dict-set! env "round" (make-primitive 38))
    (dict-set! env "gcd" (make-primitive 22))
    (dict-set! env "gensym" (make-primitive 60))
    (dict-set! env "numerator" (make-primitive 24))
    (dict-set! env "%nth" (make-primitive 55))
    (dict-set! env "<<" (make-primitive 89))
    (dict-set! env ">>" (make-primitive 90))
    (dict-set! env "%string-append" (make-primitive 91))
    (dict-set! env "sin" (make-primitive 71))
    (dict-set! env "sinh" (make-primitive 78))
    (dict-set! env "sqrt" (make-primitive 84))
    (dict-set! env "truncate" (make-primitive 37))
    (dict-set! env "tan" (make-primitive 73))
    (dict-set! env "tanh" (make-primitive 80))
    (dict-set! env "tconc!" (make-primitive 100))
    (dict-set! env "tconc-list" (make-primitive 102))
    (dict-set! env "tconc->pair" (make-primitive 103))
    (dict-set! env "tconc-splice" (make-primitive 104))
    (dict-set! env "modulo" (make-primitive 41))
    (dict-set! env "keys" (make-primitive 56))
    (dict-set! env "partial-key?" (make-primitive 57))
    (dict-set! env "polar->rectangular" (make-primitive 69))
    (dict-set! env "type" (make-primitive 111))
    (dict-set! env "make-rectangular" (make-primitive 63))
    (dict-set! env "make-polar" (make-primitive 64))
    (dict-set! env "make-dict" (make-primitive 95))
    (dict-set! env "make-tconc" (make-primitive 101))
    (dict-set! env "magnitude" (make-primitive 65))
    (dict-set! env "memq" (make-primitive 93))
    (dict-set! env "&" (make-primitive 42))
    (dict-set! env "|" (make-primitive 43))
    (dict-set! env "^" (make-primitive 44))
    (dict-set! env "~" (make-primitive 45))
    (dict-set! env "quote" (make-syntax 'primitive-syntax-quote))
    (dict-set! env "quasi-quote" (make-syntax 'primitive-syntax-qquote))
    (dict-set! env "lambda" (make-syntax 'primitive-syntax-fn))
    (dict-set! env "fn" (make-syntax 'primitive-syntax-fn))
    (dict-set! env "list" (make-syntax 'primitive-syntax-list))
    (dict-set! env "begin" (make-syntax 'primitive-syntax-begin))
    (dict-set! env "unquote" (make-syntax 'primitve-syntax-unquote))
    (dict-set! env "unquote-splice" (make-syntax 'primitive-syntax-unqsplice))
    (dict-set! env "dict" (make-syntax 'primitive-syntax-dict))
    (dict-set! env "define" (make-syntax 'primitive-syntax-define))
    (dict-set! env "define-syntax" (make-syntax 'primitive-syntax-defsyn))
    (dict-set! env "define-macro" (make-syntax 'primitive-syntax-defmac))
    (dict-set! env "append" (make-syntax 'primitive-syntax-append))
    (dict-set! env "nth" (make-syntax 'primitive-syntax-nth))
    (dict-set! env "+" (make-syntax 'primitive-syntax-plus))
    (dict-set! env "-" (make-syntax 'primitive-syntax-minus))
    (dict-set! env "*" (make-syntax 'primitive-syntax-mult))
    (dict-set! env "/" (make-syntax 'primitive-syntax-div))
    (dict-set! env "<" (make-syntax 'primitive-syntax-lt))
    (dict-set! env "<=" (make-syntax 'primitive-syntax-lte))
    (dict-set! env ">" (make-syntax 'primitive-syntax-gt))
    (dict-set! env ">=" (make-syntax 'primitive-syntax-gte))
    (dict-set! env "=" (make-syntax 'primitive-syntax-numeq))
    (dict-set! env "set!" (make-syntax 'primitive-syntax-set))
    (dict-set! env "string" (make-syntax 'primitive-syntax-string))
    (dict-set! env "make-vector" (make-syntax 'primitive-syntax-makevector))
    (dict-set! env "make-string" (make-syntax 'primitive-syntax-makestring))
    (dict-set! env "vector" (make-syntax 'primitive-syntax-vector))
    (dict-set! env "display" (make-procedure "display"))
    (dict-set! env "newline" (make-procedure "newline"))
    (dict-set! env "digamma-implementation" (make-procedure "digamma-implementation"))
    (dict-set! env "load" (make-procedure "load"))
    (dict-set! env "read" (make-procedure "read"))
    (dict-set! env "write" (make-procedure "write"))
    (dict-set! env "format" (make-procedure "format"))
    (dict-set! env "macro-expand" (make-procedure "macro-expand"))
    (dict-set! env "syntax-expand" (make-procedure "syntax-expand"))
    ;(dict-set! env "interrogate" (make-procedure "interrogate"))
    (dict-set! env "system" (make-procedure "system"))
    (dict-set! env "pwd" (make-procedure "pwd"))
    (dict-set! env "cd" (make-procedure "cd"))
    (dict-set! env "chdir" (make-procedure "chdir"))
    (dict-set! env "ls" (make-procedure "ls"))
    (dict-set! env "open" (make-procedure "open"))
    (dict-set! env "close" (make-procedure "close"))
    (dict-set! env "read-char" (make-procedure "read-char"))
    (dict-set! env "read-string" (make-procedure "read-string"))
    (dict-set! env "write-char" (make-procedure "write-char"))
    (dict-set! env "dial" (make-procedure "dial"))
    (dict-set! env "announce" (make-procedure "announce"))
    (dict-set! env "listen" (make-procedure "listen"))
    (dict-set! env "accept" (make-procedure "accept"))
    (dict-set! env "hangup" (make-procedure "hangup"))
    (dict-set! env "remote-port-open?" (make-procedure "remote-port-open?"))
    (dict-set! env "gethostbyname" (make-procedure "gethostbyname"))
    (dict-set! env "gethostbyaddr" (make-procedure "gethostbyaddr"))
    (dict-set! env "peek-char" (make-procedure "peek-char"))
    (dict-set! env "port-filename" (make-procedure "port-filename"))
    (dict-set! env "port-mode" (make-procedure "port-mode"))
    (dict-set! env "port-remote-port" (make-procedure "port-remote-port"))
    (dict-set! env "port-protocol" (make-procedure "port-protocol"))
    (dict-set! env "port-state" (make-procedure "port-state"))
    (dict-set! env "port-type" (make-procedure "port-type"))
    (dict-set! env "end-of-port?" (make-procedure "end-of-port?"))
    (dict-set! env "random" (make-procedure "random"))
    (dict-set! env "seed-random" (make-procedure "seed-random"))
    (dict-set! env "sys/gettimeofday" (make-procedure "sys/gettimeofday"))
    (dict-set! env "sys/getuid" (make-procedure "sys/getuid"))
    (dict-set! env "sys/geteuid" (make-procedure "sys/geteuid"))
    (dict-set! env "sys/getgid" (make-procedure "sys/getgid"))
    (dict-set! env "sys/getegid" (make-procedure "sys/getegid"))
    (dict-set! env "sys/set*id" (make-procedure "sys/set*id"))
    (dict-set! env "sys/open" (make-procedure "sys/open"))
    (dict-set! env "sys/close" (make-procedure "sys/close"))
    (dict-set! env "sys/read" (make-procedure "sys/read"))
    (dict-set! env "sys/write" (make-procedure "sys/write"))
    (dict-set! env "sys/pipe" (make-procedure "sys/pipe"))
    (dict-set! env "sys/fork" (make-procedure "sys/fork"))
    (dict-set! env "sys/wait" (make-procedure "sys/wait"))
    (dict-set! env "sys/exec" (make-procedure "sys/exec"))
    (dict-set! env "sys/popen" (make-procedure "sys/popen"))
    (dict-set! env "sys/pclose" (make-procedure "sys/pclose"))
    (dict-set! env "sys/vfork" (make-procedure "sys/vfork"))
    (dict-set! env "sys/kill" (make-procedure "sys/kill"))
    (dict-set! env "sys/stat" (make-procedure "sys/stat"))
    (dict-set! env "sys/*sockopt" (make-procedure "sys/*sockopt"))
    (dict-set! env "sys/time" (make-procedure "sys/time"))
    (dict-set! env "sys/chown" (make-procedure "sys/chown"))
    (dict-set! env "sys/chmod" (make-procedure "sys/chmod"))
    (dict-set! env "sys/chroot" (make-procedure "sys/chroot"))
    (dict-set! env "sys/getenv" (make-procedure "sys/getenv"))
    (dict-set! env "sys/setenv" (make-procedure "sys/setenv"))
    (dict-set! env "sys/fcntl" (make-procedure "sys/fcntl"))
    (dict-set! env "sys/fcntl-const" (make-procedure "sys/fcntl-const"))
    (dict-set! env "sys/sleep" (make-procedure "sys/sleep"))
    (dict-set! env "sys/usleep" (make-procedure "sys/usleep"))
    (dict-set! env "sys/nanosleep" (make-procedure "sys/nanosleep"))
    (dict-set! env "sys/select" (make-procedure "sys/select"))
    (dict-set! env "sys/getpid" (make-procedure "sys/getpid"))
    (dict-set! env "sys/getppid" (make-procedure "sys/getppid"))
    (dict-set! env "write-buffer" (make-procedure "write-buffer"))
    (dict-set! env "read-buffer" (make-procedure "read-buffer"))
    (dict-set! env "read-string" (make-procedure "read-string")))
