...
(define (typhon@init-env env)
    ...
    (dict-set! "format" (dict type: procedure value: "format"))
    (dict-set! "macro-expand" (dict type: procedure value: "macro-expand"))
    (dict-set! "syntax-expand" (dict type: procedure value: "syntax-expand"))
    ;(dict-set! "interrogate" (dict type: procedure value: "interrogate"))
    (dict-set! "system" (dict type: procedure value: "system"))
    (dict-set! "pwd" (dict type: procedure value: "pwd"))
    (dict-set! "cd" (dict type: procedure value: "cd"))
    (dict-set! "chdir" (dict type: procedure value: "chdir"))
    (dict-set! "ls" (dict type: procedure value: "ls"))
    (dict-set! "open" (dict type: procedure value: "open"))
    (dict-set! "close" (dict type: procedure value: "close"))
    (dict-set! "read-char" (dict type: procedure value: "read-char"))
    (dict-set! "read-string" (dict type: procedure value: "read-string"))
    (dict-set! "write-char" (dict type: procedure value: "write-char"))
    (dict-set! "dial" (dict type: procedure value: "dial"))
    (dict-set! "announce" (dict type: procedure value: "announce"))
    (dict-set! "listen" (dict type: procedure value: "listen"))
    (dict-set! "accept" (dict type: procedure value: "accept"))
    (dict-set! "hangup" (dict type: procedure value: "hangup"))
    (dict-set! "remote-port-open?" (dict type: procedure value: "remote-port-open?"))
    (dict-set! "gethostbyname" (dict type: procedure value: "gethostbyname"))
    (dict-set! "gethostbyaddr" (dict type: procedure value: "gethostbyaddr"))
    (dict-set! "peek-char" (dict type: procedure value: "peek-char"))
    (dict-set! "port-filename" (dict type: procedure value: "port-filename"))
    (dict-set! "port-mode" (dict type: procedure value: "port-mode"))
    (dict-set! "port-remote-port" (dict type: procedure value: "port-remote-port"))
    (dict-set! "port-protocol" (dict type: procedure value: "port-protocol"))
    (dict-set! "port-state" (dict type: procedure value: "port-state"))
    (dict-set! "port-type" (dict type: procedure value: "port-type"))
    (dict-set! "end-of-port?" (dict type: procedure value: "end-of-port?"))
    (dict-set! "random" (dict type: procedure value: "random"))
    (dict-set! "seed-random" (dict type: procedure value: "seed-random"))
    (dict-set! "sys/gettimeofday" (dict type: procedure value: "sys/gettimeofday"))
    (dict-set! "sys/getuid" (dict type: procedure value: "sys/getuid"))
    (dict-set! "sys/geteuid" (dict type: procedure value: "sys/geteuid"))
    (dict-set! "sys/getgid" (dict type: procedure value: "sys/getgid"))
    (dict-set! "sys/getegid" (dict type: procedure value: "sys/getegid"))
    (dict-set! "sys/set*id" (dict type: procedure value: "sys/set*id"))
    (dict-set! "sys/open" (dict type: procedure value: "sys/open"))
    (dict-set! "sys/close" (dict type: procedure value: "sys/close"))
    (dict-set! "sys/read" (dict type: procedure value: "sys/read"))
    (dict-set! "sys/write" (dict type: procedure value: "sys/write"))
    (dict-set! "sys/pipe" (dict type: procedure value: "sys/pipe"))
    (dict-set! "sys/fork" (dict type: procedure value: "sys/fork"))
    (dict-set! "sys/wait" (dict type: procedure value: "sys/wait"))
    (dict-set! "sys/exec" (dict type: procedure value: "sys/exec"))
    (dict-set! "sys/popen" (dict type: procedure value: "sys/popen"))
    (dict-set! "sys/pclose" (dict type: procedure value: "sys/pclose"))
    (dict-set! "sys/vfork" (dict type: procedure value: "sys/vfork"))
    (dict-set! "sys/kill" (dict type: procedure value: "sys/kill"))
    (dict-set! "sys/stat" (dict type: procedure value: "sys/stat"))
    (dict-set! "sys/*sockopt" (dict type: procedure value: "sys/*sockopt"))
    (dict-set! "sys/time" (dict type: procedure value: "sys/time"))
    (dict-set! "sys/chown" (dict type: procedure value: "sys/chown"))
    (dict-set! "sys/chmod" (dict type: procedure value: "sys/chmod"))
    (dict-set! "sys/chroot" (dict type: procedure value: "sys/chroot"))
    (dict-set! "sys/getenv" (dict type: procedure value: "sys/getenv"))
    (dict-set! "sys/setenv" (dict type: procedure value: "sys/setenv"))
    (dict-set! "sys/fcntl" (dict type: procedure value: "sys/fcntl"))
    (dict-set! "sys/fcntl-const" (dict type: procedure value: "sys/fcntl-const"))
    (dict-set! "sys/sleep" (dict type: procedure value: "sys/sleep"))
    (dict-set! "sys/usleep" (dict type: procedure value: "sys/usleep"))
    (dict-set! "sys/nanosleep" (dict type: procedure value: "sys/nanosleep"))
    (dict-set! "sys/select" (dict type: procedure value: "sys/select"))
    (dict-set! "sys/getpid" (dict type: procedure value: "sys/getpid"))
    (dict-set! "sys/getppid" (dict type: procedure value: "sys/getppid"))
